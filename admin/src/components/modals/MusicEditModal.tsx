...
export default function MusicEditModal({ open, onClose, isCreateMode = false, musicData }: Props) {
  ...
  // Hook 규칙을 준수하기 위해 모든 Hook 호출 후 조건부 렌더링
  if (!open) return null
      ...
      <div className="w-full max-w-6xl max-h-[90vh] rounded-2xl border border-white/10 bg-neutral-900/90 text-white shadow-2xl backdrop-blur-md flex flex-col">
              ...
              <div className="mt-4 grid grid-cols-1 gap-5 md:grid-cols-2">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg px-3 py-2.5 text-sm text-white ring-1 transition-all duration-200 ${fieldErrors.audioFile ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8'
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg px-3 py-2.5 text-white placeholder-white/50 outline-none ring-1 transition-all duration-200 ${fieldErrors.title ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8 focus:ring-2 focus:ring-teal-400/40'
                      }`}
                  />
                  {fieldErrors.title && (
                    <div className="text-sm text-red-400 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="아티스트명"
                    className={`w-full rounded-lg px-3 py-2.5 text-white placeholder-white/50 outline-none ring-1 transition-all duration-200 ${fieldErrors.artist ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8 focus:ring-2 focus:ring-teal-400/40'
                      }`}
                  />
                  {fieldErrors.artist && (
                    <div className="text-sm text-red-400 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className={`w-full rounded-lg px-3 py-2.5 text-white outline-none ring-1 transition-all duration-200 ${fieldErrors.category ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8 focus:ring-2 focus:ring-teal-400/40'
                      }`}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    disabled={!isCreateMode}
                    className={`w-full rounded-lg px-3 py-2.5 text-white outline-none ring-1 transition-all duration-200 ${fieldErrors.musicType ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8 focus:ring-2 focus:ring-teal-400/40'
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    type="date"
                    className={`w-full rounded-lg px-3 py-2.5 text-white outline-none ring-1 transition-all duration-200 ${fieldErrors.releaseDate ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8 focus:ring-2 focus:ring-teal-400/40'
                      }`}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg px-3 py-2.5 text-white placeholder-white/50 outline-none ring-1 transition-all duration-200 ${fieldErrors.isrc ? 'bg-red-500/20 ring-red-500/50' : 'bg-black/30 ring-white/8 focus:ring-2 focus:ring-teal-400/40'
                      } ${!isCreateMode ? 'opacity-50 cursor-not-allowed' : ''}`}
                  />
                  {fieldErrors.isrc && (
                    <div className="text-sm text-red-400 flex items-center gap-2">
        ...
        <div className="border-t border-white/10 bg-neutral-900/90 p-4">
          <div className="flex items-center justify-end">
            <button
              ...
              className={`rounded-lg px-6 py-2.5 text-sm font-medium transition-all duration-200 ${isCreateMode && (
                !audioFile ||
                !title.trim() ||
                !artist.trim() ||
                !category ||
        ...
        {showToast && (
          <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black/50 transition-all duration-300`}>
            <div className={`px-8 py-4 rounded-lg shadow-2xl ${toastType === 'success'
